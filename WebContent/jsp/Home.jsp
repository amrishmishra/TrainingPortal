				...
				<div class="logo-right">
					<div class="banner-top">
						...
						<ul class="nav banner-nav">
							...
							<li class="dropdown1"><a href="celebrity.html">Explore<span>search your preferences</span></a>
								<!--<ul class="dropdown2">
							...
							<li class="dropdown1"><a href="index.html">Sign up/Sign in<span>get your own account</span></a>
								<ul class="dropdown2">
